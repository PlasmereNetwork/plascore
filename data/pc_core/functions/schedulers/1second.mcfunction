...
execute if score 1s Database matches 2 run scoreboard objectives setdisplay list CurrVotes
...
execute if score 1s Database matches 0 run scoreboard objectives setdisplay list CurrVotes
