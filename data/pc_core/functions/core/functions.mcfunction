...
# SURVIVAL
execute as @a[scores={Survival=1..},tag=!t.ingame] run function pc_core:essentials/survival
...
#- TPA
execute as @a[scores={TPDeny=1..}] run function pc_core:essentials/tpa/tpdeny
execute as @a[scores={TPAccept=1..}] run function pc_core:essentials/tpa/tpaccept
# HOME / SPAWNPOINT
execute as @a[scores={SetHome=1..}] run function pc_core:essentials/sethome
execute as @a[scores={Home=1..}] run function pc_core:essentials/home
...
# BUY
#- XP
execute as @a[scores={Buy_50XP=1..}] run function pc_core:shop/buy_50xp
execute as @a[scores={Buy_500XP=1..}] run function pc_core:shop/buy_500xp
execute as @a[scores={Buy_5000XP=1..}] run function pc_core:shop/buy_5000xp
#- Other
execute as @a[scores={Shulker=1..}] run function pc_core:shop/buy_shulker_try
execute as @a[scores={BuyRTP=1..}] run function pc_core:shop/buy_rtp_try
# BOUGHT RANKS
execute as @a[scores={Firework=1},tag=special] run function pc_core:specials/firework
execute as @a[scores={Taunt=1..}] run function pc_core:specials/taunt
# TOGGLE
#- Reg
execute as @a[scores={ToggleParticle=1..}] run function pc_core:essentials/toggleparticle
