...
# Home 1
execute as @s[tag=tplx.home.true2] as @s[scores={Home=1}] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home1
# Home 2
execute as @s[tag=tplx.home.true2] as @s[scores={Home=2}] as @s[tag=home.2] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home2
...
# Home 3
execute as @s[tag=tplx.home.true2] as @s[scores={Home=3}] as @s[tag=home.3] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home3
...
# Home 4
execute as @s[tag=tplx.home.true2] as @s[scores={Home=4}] as @s[tag=home.4] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home4
...
# Home 5
execute as @s[tag=tplx.home.true2] as @s[scores={Home=5}] as @s[tag=home.5] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home5
...
# Home 6
execute as @s[tag=tplx.home.true2] as @s[scores={Home=6}] as @s[tag=home.6] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home6
...
# Home 7
execute as @s[tag=tplx.home.true2] as @s[scores={Home=7}] as @s[tag=home.7] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home7
...
# Home 8
execute as @s[tag=tplx.home.true2] as @s[scores={Home=8}] as @s[tag=home.8] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home8
...
# Home 9
execute as @s[tag=tplx.home.true2] as @s[scores={Home=9}] as @s[tag=home.9] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home9
...
# Home 10
execute as @s[tag=tplx.home.true2] as @s[scores={Home=10}] as @s[tag=home.10] as @s[tag=HomeBool] at @s run function pc_core:homes/go/go_home10
