...
# SETHOME 1
# Good.
execute as @s[scores={SetHome=1}] run function pc_core:homes/set/set_home1
...
# Good.
execute as @s[scores={SetHome=2}] as @s[tag=home2.can] run function pc_core:homes/set/set_home2
...
# Good.
execute as @s[scores={SetHome=3}] as @s[tag=home3.can] run function pc_core:homes/set/set_home3
...
# Good.
execute as @s[scores={SetHome=4}] as @s[tag=home4.can] run function pc_core:homes/set/set_home4
...
# Good.
execute as @s[scores={SetHome=5}] as @s[tag=home5.can] run function pc_core:homes/set/set_home5
...
# Good.
execute as @s[scores={SetHome=6}] as @s[tag=home6.can] run function pc_core:homes/set/set_home6
...
# Good.
execute as @s[scores={SetHome=7}] as @s[tag=home7.can] run function pc_core:homes/set/set_home7
...
# Good.
execute as @s[scores={SetHome=8}] as @s[tag=home8.can] run function pc_core:homes/set/set_home8
...
# Good.
execute as @s[scores={SetHome=9}] as @s[tag=home9.can] run function pc_core:homes/set/set_home9
...
# Good.
execute as @s[scores={SetHome=10}] as @s[tag=home10.can] run function pc_core:homes/set/set_home10
