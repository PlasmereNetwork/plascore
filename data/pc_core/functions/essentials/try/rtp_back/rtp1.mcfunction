execute at @s store result entity @s Pos[0] double 1 run scoreboard players get @p[scores={home=1}] rtp.xpos
execute at @s store result entity @s Pos[1] double 1 run scoreboard players get @p[scores={home=1}] rtp.ypos
execute at @s store result entity @s Pos[2] double 1 run scoreboard players get @p[scores={home=1}] rtp.zpos
