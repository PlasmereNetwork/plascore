...
time set day
# Forwarding.
execute as @a[distance=..10] run advancement grant @s only quests:sun
# Clean up.
kill @e[type=item,limit=5,sort=nearest,distance=..2]
# Tellers.
tellraw @a [{"selector":"@p","color":"green"},{"text":" just set it to day!","color":"green"}]
